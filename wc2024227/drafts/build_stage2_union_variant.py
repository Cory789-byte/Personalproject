...
OUT = "/home/user/Personalproject/wc2024227/drafts/out/REFERRAL_Stage2_cl1.11.2b_MSH-INJ-5795_with_UNION_SECTION.pdf"
...
S = {
 ...
 "note":  ParagraphStyle("note", fontName="Helvetica-Oblique", fontSize=9.0, leading=13,
                         textColor=colors.HexColor("#7A5C00"), backColor=colors.HexColor("#FFF7CC"),
                         borderPadding=(5,6,5,6), leftIndent=4, rightIndent=4, spaceAfter=8),
...
for t in out_paras:
    ...
    elif t.startswith("[Heath and Emily"):
        flow.append(Paragraph(esc(t), S["note"]))
