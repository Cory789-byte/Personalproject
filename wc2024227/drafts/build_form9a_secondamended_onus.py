...
s += [P("PART C &mdash; CONTENTIONS", PART),
 ...
 P("<b>4. &nbsp;Section 32(5)(a), first limb &mdash; circumstances that are not management "
   ...
   "notifications were, on nine occasions, reported by a clinician to the Switchboard Manager as having "
   "reached the wrong medical team, and the Switchboard was not told of those reports for six days "
   "(Stressor 1(g)); (iii) a clinical service wrote twice to the Switchboard, each time marked of "
   "high importance, stating that calls for another service were being put through to it and that it \"can not help patients or other clinical staff with OPD issues\", and the directory entry it asked to "
   "have corrected is not alleged to have been amended (Stressor 1(h)); and (iv) complaints arriving at the console were, on the "
