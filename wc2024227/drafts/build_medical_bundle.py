...
TABS=[
 ...
 dict(n=4, title="Report of Dr Krishnaiah, Mind and Memory Service, 13 February 2025, prepared for QSuper; and the exchange of 5 to 8 September 2026 in which he identified it as his answer to the three matters in issue: Major Depressive Disorder with anxious distress, presenting as \"workplace stress stemming from issues with management and rostering at Queensland Health\"",
      held="The report: Respondent's amended List of Documents item 10. The exchange: not on the Respondent's list, except the notice, which is the Respondent's own Form 29 at item 3; served with this bundle.",
      incl="The report, all four pages, reproduced whole so that nothing relied upon is read out of its context. Then the exchange, three documents, in this order. (1) The Appellant's email to Dr Krishnaiah of 5 September 2026 at 10:49 am, asking him to address the three matters in issue named in the Respondent's notice of non-party disclosure - whether the Appellant sustained a personal injury, whether it arose out of or in the course of employment, and whether employment was a significant contributing factor - from his own assessments and records (pages 5 to 7 of the chain as printed). (2) Dr Krishnaiah's reply of 8 September 2026 at 7:18 am: that he had attached \"the report that captures the relevant information you have requested\" (page 1 of the chain). (3) The Respondent's Form 29 notice of non-party disclosure to the Mind and Memory Service, sealed 4 July 2025, pages 1 and 2, being the sealed cover and the page stating the three matters in issue. The report he attached is the report that precedes it in this tab. In it, at page 1: the diagnosis, \"Major Depressive Disorder with anxious distress (DSM 5- 296.23)\"; that he \"presented with workplace stress stemming from issues with management and rostering at Queensland Health\"; that \"These issues began approximately one year ago when a new manager was appointed\"; that after raising concerns about rostering and fatigue management \"he experienced changes in work conditions including shorter breaks, more night shifts\"; and that \"His pay was withheld or delayed for up to five months at a time, leading to significant financial stress\". No report has been prepared for this proceeding.",
      omit="Of the exchange: pages 2 to 4 of the email chain, being the intervening messages of 5 September 2026, which are not relied upon; and pages 3 to 6 of the Form 29, being the schedule of documents sought and the remaining form pages. Of the report: none.",
      srcs=[('pdf', D+'medical/2025-02-13_MindAndMemory_report_QSuper_LouiseIngs.pdf', [1,2,3,4]),
...
def tab_sheet(t):
    ...
    s=[P(HEADER[0],HD),P(HEADER[1],HD2),P(f"TAB M{t['n']}",TAB),P(t['title'],TT),
       ...
       Spacer(1,4*mm),P({8:"This tab is added so that the Respondent's own position on the documents at Tabs M1, M2, M4 and M7 sits with them.",
         4:"The exchange follows the report so that the question, the answer and the notice the question came from can be read with it. Schedule row 4 states what the report is, and is not, relied upon for."}.get(t['n'], "Schedule row "+str(t['n'])+" states what this document is, and is not, relied upon for."),B)]
