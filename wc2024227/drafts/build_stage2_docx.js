...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      p({}, [ slot("[To be completed on Together Queensland's advice: whether Together will represent me, or attend with me, at the Stage 2 conference; and the union's confirmation of my delegate status for the workplace, with the request that this Stage 2 process be conducted consistently with clause 3.1.5. If the union's advice has not arrived before sending, delete this section and renumber section 4 to 3 — the referral stands on its own.]") ]),
