...
ARCHIVE=[
 ...
 (D+'correspondence-2026/2026-08-04_1335_Taylor_Stage1_ack_24h_not_achieved_and_leave_request.pdf','4 Aug 2026, 1:35 pm','Taylor → Shepherd, IM, HR, cc Moran','⭐⭐ Stage 1 acknowledgement. Concedes the EB12 cl 1.11.2(a) 24-hour timeframe "will not be achieved". States "I am required to process leave on your behalf" for 20 Jul – 2 Aug; records the recreation leave balance at 41.21 hours; and undertakes that absent a response she will apply it "to ensure you receive the available paid leave entitlement for this period". The payslip for that fortnight records NP Sick Leave 76.00 hours, $0.00'),
