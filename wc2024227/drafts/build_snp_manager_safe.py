...
OUT = 'out/SNP_statement_MANAGER_SAFE_11SEP2026.pdf'
...
S = [Paragraph('CORY SHEPHERD', NAME),
     ...
     B('Throughout this period I remained under the care of a treating specialist for the same '
       'condition, under continuous treatment.'),
     B('<b>On 13 February 2025</b> &ndash; within this period &ndash; that practitioner provided a '
       'report recording the continuing condition, its functional effect, and the treatment then in '
       'place. It is available to Injury Management on request.'),
     ...
     H('4A. &nbsp;The medical evidence'),
     P('Four work capacity certificates cover these absences. Together they certify <b>no capacity '
       'for any work over the period 1 July to 6 October 2024</b>. They have been provided to '
       'Injury Management and to Payroll with this statement, and are available to any officer who '
       'requires them for the purpose of processing these applications.'),
     ...
     Spacer(1, 14),
     Paragraph('<i>Work capacity certificates for both periods have been provided separately to '
               'Injury Management and to Payroll.</i>', ADDR)]
...
# no attachments in the manager-safe version
