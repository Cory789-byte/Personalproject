...
INTRO = [
 ...
 ("Use at hearing.", "Against each document is stated what it is, and is not, relied upon for. Items 3, 4 and 5 contain "
  ...
  "names of all witnesses filed today, and will be called. Omitted pages are identified on each tab sheet. Tabs 8 and 9 add the Respondent's responses of 18 February 2026 and the exchange with the author of 5 to 8 September 2026."),
