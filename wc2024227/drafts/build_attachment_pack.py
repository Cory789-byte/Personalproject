...
s.append(Spacer(1,10)); s.append(P('Nothing in Sections A and B has been altered other than the omission of standard email boilerplate. Sections C and D are reproduced as published.',SM))
