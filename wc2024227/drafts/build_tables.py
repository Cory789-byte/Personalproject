...
s=[P('TABLE 1 — LEAVE REQUESTED FROM 3 JULY 2026: EVERY REQUEST, WITH THE TAB IT IS IN',H1),
   P('Cory Shepherd (388372) · tab numbers refer to Section A, the original emails · 3 September 2026',SM),Spacer(1,5)]
rows=[[P('<b>Tab</b>',SMB),P('<b>Date</b>',SMB),P('<b>To</b>',SMB),P('<b>What was asked</b>',SMB),P('<b>What happened</b>',SMB)]]
data=[('1','2 Jul, 2:38 pm','(from Ms Taylor)','“Unless you advise me otherwise, I will process your shifts that you have not worked as Sick Leave – please confirm by Friday 3rd July before 2:00pm”','the coding is created'),
 ('1','3 Jul, 2:49 pm','(from Ms Taylor)','“As you have not confirmed leave type … I will continue to process as Sick leave / Sick leave no pay”','—'),
 ('1','3 Jul, 3:18 pm','Ms Taylor','“could you please process the balance as ANNUAL LEAVE rather than sick leave without pay” — 29 minutes later','Sick Leave – No Pay applied every day since'),
 ('2','10 Jul, 8:35 am','Ms Forrest','shifts to be “treated as PAID TIME and … not deducted from my leave”','unanswered'),
 ('2','13 Jul, 4:39 pm','Injury Mgmt','“I ask again” — paid time; the basis in writing if refused','15 Jul: pay refused'),
 ('3','28 Jul, 5:39 pm','Injury Mgmt','contests the sick-leave-no-pay coding','holding replies'),
 ('4','5 Aug, 7:30 am','Stage 1','pay restoration; re-credit of leave debited since 3 July','none'),
 ('5','24 Aug, 11:13 am','Ms Roberts','“the appropriate LEAVE BE APPLIED and … an AVAC be submitted”','“speaking with Chloe this afternoon”'),
 ('5','28 Aug, 2:18 pm','Ms Roberts','AVAC update','none'),
 ('6','31 Aug, 10:59 am','Ms Taylor','application: LSL from 13 Jul; annual leave on exhaustion; AVAC today; “I confirm I am not applying for personal leave”; under protest, subject to re-credit','one fortnight at “0.5 FTE”, with sick leave; LSL enquiry 4469554'),
 ('6','31 Aug, 4:06 pm','Ms Taylor','76 hours, not 0.5 FTE; no sick leave; the period from 13 Jul; service dates','—'),
 ('6','2 Sep, 11:07 am','Ms Taylor','ad hoc payment today','“cannot be processed prior to 9 September”'),
 ('6','3 Sep','(from Payroll / Ms Taylor)','eligibility date “04/09/2026”; leave audit opened; no backdating; no ad hoc before 9 Sep','—')]
...
data=[('3 Jul – 2 Aug','“Sick Leave – No Pay” applied from 3 Jul (and to shifts before it, per the email of 2 Jul) against the instruction of 3 Jul 3:18 pm. Paid nil on 15 Jul, 29 Jul and 12 Aug','76','Correct the coding from the first date it was applied; AVAC to be submitted (C13 §2); review of pay entitlements from 3 Jul (C13 §9), with the leave audit; long service leave from 13 Jul on the agreement’s dates','missed'),
 ...
 ('3 Jul on','SPECIAL LEAVE ON FULL PAY — Directive 12/24 cl 6.1 (applies via EB12 cl 9.12); not debited from any leave account. Applied for 28 Jul (Tab 3, point 4) and 5 Aug (Tab 4). No decision communicated','76','Delegate’s decision in writing, with reasons, addressing cl 6.5 — reason, duration, impact of refusal. If approved, recreation leave and LSL re-credited','—'),
...
s.append(P('All leave applied for is applied for under protest and subject to re-credit, on the basis set out in the application of 31 August (Tab 6, 31 Aug 10:59 am, paragraph 4). Certified fit with restrictions since 3 July 2026; ready and available to work throughout.',B))
