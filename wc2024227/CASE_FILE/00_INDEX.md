...
|---|---|
| `01_ORDERS_AND_DIRECTIONS` | Orders and directions issued by the Commission in this proceeding. 7 file(s) |
| `02_SUBMISSIONS_TO_QIRC/01_pleadings` | The Appellant's statement of facts and contentions. 1 file(s) |
| `02_SUBMISSIONS_TO_QIRC/02_applications_and_notices` | Applications and notices filed in the Industrial Registry. 7 file(s) |
| `02_SUBMISSIONS_TO_QIRC/03_affidavits` | Affidavits filed in the Industrial Registry. 4 file(s) |
| `02_SUBMISSIONS_TO_QIRC/04_filed_9_September_2026` | Filed in the Industrial Registry on 9 September 2026 under direction 1 of the Further Directions Order (3) dated 19 August 2026. 3 file(s) |
| `02_SUBMISSIONS_TO_QIRC/05_to_be_filed` | Prepared for filing. 1 file(s) + pointer |
| `03_SERVED_ON_THE_RESPONDENT/01_notices_to_admit_28AUG2026` | Notices to admit facts and documents served on the Respondent on 28 August 2026 at 1:47 pm under rule 49(1). 0 file(s) + pointer |
| `03_SERVED_ON_THE_RESPONDENT/02_direction_2_material_9SEP2026` | Served on the Respondent on 9 September 2026 under direction 2 of the Further Directions Order (3) dated 19 August 2026. 10 file(s) |
...
## Orders, and submissions to the Commission
