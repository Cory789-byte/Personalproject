...
## 14 Aug 2026 — BIDIRECTIONAL TIMING ANALYSIS (`skill/references/BIDIRECTIONAL-TIMING-ANALYSIS.md`)
- Every request in both directions with its latency; the deadline asymmetry; the disclosure flow
  map; and the silence map.
- **Latency:** their median to a substantive answer on a request ≈ **3 weeks**; their median to a
  challenge to authority ≈ **5 hours**. His median ≈ **same-day to 3 days**.
- ⭐⭐ **DEADLINE ASYMMETRY (sharper than latency, because deadlines are chosen):** every deadline
  they impose on him is measured in days (retract: immediate · EMR: 1 day · RFMI: 7 calendar days ·
  meeting: 6 days). **Every deadline he sets them is ignored.** He has met or substantially met
  every deadline imposed on him; the one blemish is his own (EMR signed 3 days past its due date).
- ⭐⭐ **THE THIRTEEN-MONTH BLIND SPOT:** the NNPDs were issued 4 Jul 2025 and disclosed to him
  14 Aug 2026 — only after he asked. For 13 months he litigated without knowing the Regulator had
  asked Qld Health whether **payslips had been amended and when**, and whether the **2020 agreement
  was complete**. ⭐ STANDING RULE ADOPTED: **ask the Regulator periodically for any further
  third-party notices issued.** You cannot use what you do not know they sought.
- ⭐ **Disclosure tracks THEIR activity, not his requests** (14/22 Jul 2025 follows their evidence
  week; 11 Jun 2026 follows the Apr 2026 NNPD response; 14 Aug 2026 only after he asked AND
  served). **For 20 months disclosure ran one way — toward him. On 12 Aug it reversed for the
  first time**, and both institutions moved within 48 hours.
- ⭐ **Evidence-gathering timing:** their case was assembled in ONE WEEK in July 2025; his has been
  assembled in the last ten weeks. **He is ~12 months behind them** — explicable (working,
  unrepresented, unfunded) but material.
- ⭐⭐⭐ **THE SILENCE MAP — the through-line of the whole matter.** Nine questions across two years
  and four subjects (roster · the 2020 agreement · exclusion · wages · the medical inquiry) reduce
  to **ONE question, never answered: *what is the basis?*** Use as one line at the 21 Aug meeting.
- ⚠ **VERIFY BEFORE RELYING:** the LOD records MSH's partial production + objection at **5 Jun
  2026** (Ruttan), but the repo records his Form 29 as filed/sealed **23 Jun 2026**. An objection
  cannot pre-date the notice. Establish the true sequence — most likely an earlier served notice
...
## 2026-08-21 — THE ROBERTS / PETERING CONFERENCE (Cory's account, same day, voice notes) [R]
⚠ RECALL ONLY, given in fragments immediately after. Verify anything load-bearing before use.
- Meeting occurred. NO OUTCOME. Cut short — his phone died mid-call.
- He is to provide something further to them MONDAY (24 Aug — the same day as the cl 10.3.6 deemed
  refusal). ⚠ CLARIFY WITH CORY exactly what he undertook to provide.
- ⭐⭐⭐ **THEY SAID DR KRISHNAIAH HAS WRITTEN THEM A LETTER.** Cory has not seen it. Highest-priority
  item on the board: it is almost certainly the 12 Aug precondition in writing (Dr K requiring MSH
  to identify WHY the information was requested). If so the report IS gated ⇒ Branch E of the FDO(3)
  decision tree, and the registry extension on direction 2 becomes NECESSARY not optional.
- ⛔⛔ **HE IS LOSING HIS HOME.** Wage stoppage since 13 July has forced him to move out. This is now
  the most urgent fact in the matter and it is not yet in any written communication to MSH.
- He raised that MSH allowed ~one month to pass before even asking the medical question. Correct and
  useful: ECC 3 Jul → RFMI 31 Jul.
- On their "concern for your safety": he answered that genuine care would be holistic and objective,
  whereas their approach is subjective. Good framing; keep it.
- QSuper: they again asserted a "full open claim". He had already corrected this. ⇒ put the
  correction in writing once, flatly (no IP benefit paid since 31 May 2026).
- He asked for his medical file.
⚠ DISCLOSED IN THE MEETING (noted factually, no criticism — he was mid-crisis and cut short):
  (a) the relationship separation and its timing; (b) matters touching the dismissal; (c) the PID;
  (d) that intimate/sexual history from his file had been shared among others. These are outside the
  agreed agenda and (b) engages standing rule 10. CONSEQUENCE TO MANAGE: HR file notes may now
  record them. Do not repeat them in writing; do not expand; if minutes arrive, correct only what is
  factually wrong.
NEXT ACTIONS SET: (1) written request for the Krishnaiah letter — to MSH and to the practice;
...
## 2026-09-08 (evening) — Payroll LSL replies of 8 Sep, the 7 Sep internal chain, and the ART attachments
- 7 Sep 08:56 Cory's LSL email (EMAIL_1). 08:59 fwd to Payroll Service Leader. 10:55 Strachan→PIARCT: WorkCover claim in the three periods? "whether these periods should be recorded as actual LWOP". 11:50 PIARCT (N Williams): no WorkCover claim; Income Protection claim; **Part B lodged by PIARCT 01/10/24: last attended 03/06/24, sick leave commencing 07/06/24**. 12:02 Strachan→QSuper Employer Services + Injury Mgmt: IP claim approved as at 04.06.2024? 12:58 Harrison: ART 23/06/2026 accepted claim; ART 31/07/2026 open claim, no payments; not advised ceased. 13:28 Strachan→Taylor (cc Service Leader, D French): were 21.06.24–20.09.24 and 13.12.24–23.02.25 intended as Sick No Pay? if so first 3 months credited; forms needed.
- 8 Sep 14:24 Strachan→Cory+Taylor: "We believe that the periods ... should have been booked as Sick No Pay (SNP) rather than LWOP"; new forms for both; first 3 months of each then recognised. Attached the two ART emails. 15:22, 15:29 recall notices. 15:38 second reply: LWOP >9 days excluded (15/24 and 01/19 cited together), 189 days, "contact your local HR team"; SNP path omitted. 15:39 ×3 recall notices. Cory holds all (external mailbox).
- Metadata: Cory's Outlook prints (Chromium "Reading Pane") 8 Sep 17:54–18:06 AEST — his own. ART emails as attached: Author **Michelle Harrison**, "Microsoft: Print To PDF", Outlook Memo Style; 31 Jul file created 7 Sep 12:50:52, **modified 12:53:10 with Adobe XMP toolkit** (opened/saved in an Adobe product after printing); 23 Jun file created 12:55:07, unmodified. Printed Outlook fields expose Injury Mgmt case-handling: "Categories: 2.Michelle (Team1)"; "Notes & Actions: 26.06.26 - PC with James monday 9.30am".
