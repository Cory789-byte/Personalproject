# THE RESPONDENT'S PLAYBOOK — EVERY STANDARD TACTIC IN A PSYCHIATRIC WC APPEAL
> ⛔ Strategy layer. What the Regulator (Matheson/Willson) can run in WC/2024/227, and the
> counter already built for each. Banked 3 Aug 2026. Read with CHRONOLOGY-SHIELD and
> case-theory-synthesis §15.
...
| 6 | **Expert contest** | Respondent IME attributes to personal factors / personality | Treating relationship depth; the dating cross ("explain how a Dec 2024 event contributed to an Oct 2024 diagnosis"); Report B scoped to chronology; worked-against-advice = anti-malingering |
| 7 | **Fragmentation** | Atomise the course into isolated, individually-defensible incidents | Rule 7: severity = whole course; the pattern evidence (substitutions x2, asymmetry pair, measured-pattern timings) |
| 8 | **Onus pressing** | "Appellant must prove; he hasn't" (de novo, his onus) | The 64G: their records produce his proof or their sworn absence; the corpus is the proof of events |
| 9 | **Attrition / procedural friction** | Delay, disclosure games, late service, listings | Clocks logged; the delay ledger itself becomes organisational-justice colour; costs foundation (rejected Calderbank) grows with their delay |
| 10 | **The personal-story narrative** ("so much else going on") | Undated turmoil framing: DV matters, arrest, homelessness | SHIELD Parts 1–7: date everything; relevance first; completeness swings the door back; child gate on the sister |
| 11 | **Witness denial** | Managers deny stressor events / "roster was equitable" | The denial is itself an anchor (rule 3); documents contradict; Taylor's own disclosure supplies knowledge evidence |
...
the bond, the BWC assessments, the missed confirmed return; the child material meets the
s 159 gate; and a respondent seen hammering a self-represented appellant's family trauma in
a de novo hearing hands Dwyer sympathy and credit. Their competent play is the sanitised
expert-report line — which is why the dating cross (tactic 6 counter) is the single most
