# Confirmed Record — WC/2024/227

**Everything here is verified against a source document.** Each entry notes its source. Do not add anything to this file that has not been read in a primary document. Reconstructions from memory go in `working-theories.md` until confirmed.

---

## Parties and roles

- **Appellant:** Cory Lea Shepherd, AO3, Logan Hospital Switchboard, Metro South HHS. Self-represented (Rule 9) since Saines Legal withdrew ~9 Feb 2026. Email coryshepherd1@hotmail.com; work email Cory.shepherd@health.qld.gov.au; mobile 0417 400 227 (per Feb 2026 filing) / 0422 438 627 (per PID form — two numbers appear; confirm current).
- **Respondent:** Workers' Compensation Regulator. Carriage: **Renee Matheson**, Senior Appeals Officer, Workers' Compensation Regulatory Services, OIR (Renee.Matheson@oir.qld.gov.au, P 07 3842 2792, M 0460 021 030, 150 Mary Street Brisbane). Counsel: **Ms Lisa Willson** — barrister, 35 West Chambers / Hemmant's List, called Feb 2008; **current Counsel Panel member for the Workers' Compensation Regulator** (QIRC); previously appeared for the Regulator incl. *Weigel v Workers' Compensation Regulator* [2019] QIRC 162. **WHS specialist credentials (the "dual role"): Bachelor of Applied Science (OHS); author, LexisNexis "National Work Health and Safety Law"; former Senior Consultant, Aussafe Consulting; Adjunct Associate Professor, UQ OHS Science Program** (source: Hemmant's List profile, fetched 12 Jun 2026). In this matter: per Appellant's recollection she is the Counsel of the 17 Feb 2026 unavailability email (mention moved 26→27 Feb) and appeared at mentions/conferences; **the "5 weeks to respond" she noted anchors to the 7 Apr 2026 FDO — Respondent's amended SOFC due 13 May = exactly 35 days after the Appellant's 8 Apr amended 9A (the Neville pleading, Stressor 3(b))**. **Willson appearance pattern (source: Appellant's direct recollection, 12 Jun 2026):** appeared at the 27 Feb 2026 mention, the 13 Mar 2026 s 552A conference, and the 7 Apr 2026 mention (where the 5-week response window was set); **did NOT appear at the 22 May 2026 mention** — the first listing after the Regulator filed its amended SOFC (13 May). Documented corroboration of the arc: counsel was briefed for the 26 Feb listing (the 17 Feb unavailability email presupposes it); the 22 May mention was the MSH-objection-timetable listing at which MSH also did not attend. Note: WHS-specialist panel counsel is specialisation, not an impropriety — its significance is what it says about how expertly the Regulator reads the FRMS/Neville case.
- **Non-party:** Metro South Hospital and Health Service. CE **Noelle Cridland** signed the 5 June objection (ref K-LM26/729). Legal: Myla Ruttan (Principal Lawyer), Lauren Griffin. Exec Director Chris Thorburn (served the Form 29).
- **Named individuals in the conduct:** Chloe Taylor (Donovan-Taylor) — Line Manager, Switchboard. Tammy Reese — Director. Janelle Loader — Director, Ethical Standards Unit (signed the 24 Dec 2024 PID closing letter).
...
- **2 March 2026** — Notice of Listing: conference before Dwyer C, **13 March 2026, 10:00 AM**, Level 22, 66 Eagle St (source: Notice of Listing).
- **13 March 2026** — conference; did not resolve.
- **7 April 2026** — Amended Form 9A filed (operative stressors).
- **22 April 2026, 5:08 PM** — Form 29 sealed (22 April) and served on MSH (Thorburn); forwarded to Chief People & Partnerships Officer within 18 minutes.
- **22 May 2026** — chambers direction: MSH objections due 4:00 PM, 5 June 2026.
- **5 June 2026, 3:02 PM** — MSH objection served (Cridland, K-LM26/729).
- **11 June 2026, 11:03 AM** — Regulator supplementary disclosure to Appellant (Matheson).
- **12 June 2026** — Rule 64G filing deadline (day 7).

## The 7-hour break (KEYSTONE)

- Appellant rostered to finish 23:00 and start next shift 06:00 = 7-hour break (Form 24 Resp ¶1: **admitted**).
- Award/FRMS minimum 10 hours, or 8 by written agreement (Resp ¶3: **admitted**).
...
- **¶5** — fatigue grievance / Reese email admission. Admitted.
- **¶6** — Taylor removed a page from the communication book. Admitted (but NOT that it bore Cory's handwriting — "no copy of the page").
- **¶8** — [the procedure fact]. Admitted, "there was a procedure in place for this to occur."
- **¶14** — [comms book / 6 June 2023]. Admitted.
- **¶17** — Union Encouragement Policy "says words to that effect." Admitted (policy wording only).
- **¶20** — ESU determined PID. Admitted.
- **¶21** — Reese retraction direction. **Admitted BUT "no correlation between the two events"; Reese also emailed re retraction 21 May 2024; "all emails to be read as a whole."** Event admitted, causation contested.
- **¶25** — no Form 29 served on Cory before the medical records. **Admitted**, with defence: "no requirement to do so pursuant to s 64D"; denies breach of r 64E.
- **¶40** (Notice ¶46) — Taylor's 21 May "waiting payroll confirmation" email. Admitted.

### ADMITTED-BUT-RESERVED ("de novo, for the Commission")
- **¶2** — the 7-hour roster as unreasonable: does not admit; for the Commission.
- **¶16** — yelling as not reasonable management action: denied; "characterisation is for the Commission."
- **¶34** (Notice ¶37, IRO finding): contents admitted, relevance reserved to Commission (see keystone note above).
...
- **¶39** (Notice ¶¶42–45) — pay disparity denied: **"the comparator does not represent a true comparator… the roster was equitable."** ← **The equitable-roster claim is the contested fact Items 8/9/10 attack. Anchor relevance here.**
- **¶41–43** (Notice ¶¶47–49) — Taylor's delay/false statement denied: "needed payroll confirmation"; "not false or misleading"; "no lack of diligence."

### EVIDENTIAL / PARTIAL
- **¶10** — "burn book": does not admit; says the email states Taylor *felt like* the book was being used as a "burn book"; "read the email as a whole"; **denies the comms book is a government record.**
- **¶11** — does not admit the Mean Girls reference ("unsure of the relationship to the film").
- **¶13** — has seen Jeffrey's email of **18 July 2024**: "rips the page out," "humiliating for Cory."
- **¶15** — Jeffrey email: "yelled at Cory over something that did not warrant her reaction" BUT Jeffrey **did not witness it** — told by Cory. **Hearsay flag on the yelling particular.**
- **¶18** — admits Cory texted Taylor 5:03 PM "just putting his hand up" but says "not a formal notification."

### MEDICAL RECORDS — THE FORM 29 FINDING (critical)
- **¶23** — denies "full medical history"; says records obtained "in a date range in line with **Form 29 – Notice of non-party disclosure, signed by a Senior Registry Officer on 4 July 2025**," received before 16 July 2025. **→ There IS a Form 29 for the medical records, Registry-signed 4 July 2025.**
- **¶24** — no footer on the records, but page one states printed **8 July 2025**; source of date unverifiable by Respondent.
- **¶25** — see ADMITTED: no Form 29 served on Cory; s 64D no-obligation defence. **The privacy/exclusion fight is now a legal question on admitted facts.**
- **⚠ SUBDIVISION 7A — verified verbatim against the legislation (legislation.qld.gov.au, sl-2011-0237, 17 Jun 2026):** the Respondent's no-service position is TEXTUALLY CORRECT. **r 64D(1)(a)** requires a copy be served on *"a person, **other than a party** and the non-party, about whom information is sought"* — Cory is a party, so he is carved out; there was no duty to serve him, and **no "breach of r 64E"** (r 64E is an objection right, not a service duty). **Do NOT plead a service breach / "unlawfully obtained" — it fails on the carve-out.** Cory's remedy is **r 64E(2):** *a person affected by the notice who has not been served may object **at any time with leave*** — grounds **(e) confidential nature** and **(f) effect on any person** fit the medical records; the s 580 sealing already recognises that sensitivity. Re-ground the exclusion application on r 64E(2)(e)/(f) + s 580 + relevance/prejudice, NOT illegality. Corollary for Cory's OWN Form 29: the Line Manager and Director ARE non-parties about whom info is sought → he is **required** to serve them under **r 64D(1)(a)** (MSH, the producer/non-party, served last per r 64C(2)). r 64B: non-party production available only if no other reasonably simple and inexpensive way.
- **¶27** (Notice ¶30) — served records on Cory's solicitors **22 July 2025**; not notified solicitors had ceased acting until **29 July 2025**.
- **¶29** (Notice ¶32) — 14 July 2025 email direct to Cory was "in error," should have gone to solicitors; **"medical records were not in the possession of the Regulator at the time of sending the email on 14 July 2025."**
- **¶30–31** — Nanayakkara entry / 16 Nov 2023 "no psychological illness": admits the entries exist, does not admit accuracy.
- **¶32** (Notice ¶35) — **Regulator asserts the records show anxiety and ADHD history from 26 October 2022, "missing from Exhibit A5."** ← cuts at the clean-baseline point; live tension for the medical case.

### MEDICAL CAUSATION
- **¶33** (Notice ¶36, Hawes) — admits the certificate says mechanism was "ongoing breaking of workplace rules by bosses, victimizing him," **denies that as fact, and corrects the date: signed 8 September 2024, NOT 1 July 2024.** ← fix any citation that says 1 July.
- **¶35–36** (Krishnaiah / MDD; "premature exposure… significant deterioration") — admits the reports say it; does not admit accuracy.

### PAYROLL
- **¶37** (Notice ¶40) — [payroll directive / "IMMEDIATELY"]. Admitted.
- **¶38** (Notice ¶41) — Taylor submitted AVAC **28 May 2024** (admitted); says on 21 May she emailed she was "waiting for payroll confirmation" and would submit next pay run. **Delay admitted; justification contested.**

## The 11 June bundle + MSH Item 11 — extracted facts (source: the files themselves, extracted in-repo 11 June 2026 — full detail in `documents/METADATA_REGISTER.md`)

- 11 June bundle is **10 pages** (not 23): pp 1–4 leave-form 15480560 walkthrough (Request/certification/Attachments/Comments/Process Flow/History), p 5 Reese retraction email **15 May 2024 6:23 PM** (full text incl. Recall-This-Message instructions, printed from Matheson's mailbox), p 6 Cory's "Office Hours and Departmental Directives" email **15 May 2024 1:15 PM** (To Taylor + Logan Switch, Cc 17 staff + LBH_HR), p 7 **McGinley email 16 May 2024 11:43 AM** (To Reese, Tracey Smith; Cc Punch, Pritchard, McNamee; attachment "Chloe Taylor scc-complaint-form.docx") + **LBH_HR (Michelle Harrison) forward 15 May 2024 3:41 PM**, p 8 Cory's PID email **15 May 2024 3:35 PM** (To MetroSouthESU; CO_Complaints; LBH_HR), pp 9–10 ESU PID complaint form dated **13/05/2024**.
- **The six-minute routing is on the face of the bundle:** PID email 3:35 PM → HR forward 3:41 PM; Reese retraction 6:23 PM same day.
- **PDF metadata:** container created 6 May 2026 13:31:59 (+10), revision-1 ModDate 6 May 13:32:23, **revision-2 ModDate 11 June 10:56:12** (7 min before Matheson's 11:03 email). Incremental update; **revision-1 page-tree `/Count` = 4**, final = 10.
- **Leave-form 15480560 history (exact timestamps):** draft 20.02.2024 11:24:48; submitted 11:41:27 (attachment IMG_3669.jpg 11:41:29); declined (Donovan-Taylor) 21.02.2024 12:23:43; resubmitted 28.02.2024 06:07:32; declined 29.02.2024 09:06:07; resubmitted 29.02.2024 11:07:28; approved (Donovan-Taylor) 29.02.2024 11:21:03; Manager + Delegate approved (Reese) 01.03.2024 16:05:08.
- **Item 11 AVAC history print:** Author Myla Ruttan, printed 2 June 2026 16:55; myHR session banner shows user **"Estelle Bain"** (role unknown — access-log target).
...
- **⚠ DATE LOCK (source: the 5 June letter itself, read verbatim 17 Jun 2026): the Notice's email-item date range is "1 December 2023 to 30 June 2024".** MSH quotes that range THREE times (Items 3(a), 8, 10) as the basis for its breadth objection. This is the operative sealed Notice (22 Apr 2026). A drafts file (v5.1) and a "Supplementary Form 29 / CASE_DATA" note once said "1 January 2023" for Item 3(a)/(b) — that does NOT match the sealed Notice MSH responded to; the Form 4 must say **1 December 2023**. Item 9 (access) is likewise 1 Dec 2023.
- **Item 19 — MSH's own narrowing proposal (verbatim): custodians = the Switchboard line manager, the Director, and the Logan Hospital HR team; suggested date "17–18 March 2024".** That date predates the 18 May 2024 union request, so it cannot capture Item 19; adopt MSH's CUSTODIANS but press the 18 May–18 Jun 2024 window. MSH also flags Together Qld as a possible affected party — answered: the Item seeks only emails already in MSH custodians' mailboxes, not Together's own records.
- **Item 18 — MSH grounds the "already conceded" objection on Form 24 Para 14 + Form 9A Stressor 1(b)** (not Para 6). Para 6 = the page-removal admission.
