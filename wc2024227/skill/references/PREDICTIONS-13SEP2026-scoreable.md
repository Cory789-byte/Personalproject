# Data-driven predictions, 13 September 2026 — written to be scored
> ⭐ **The point of this file is falsifiability.** Each prediction has a date, a stated
> confidence, the evidence it rests on, and a blank OUTCOME line. Fill the outcome in when it
> happens. A prediction note that is never scored is decoration.

---

## A · THE DATA THESE REST ON

### A1 · The Respondent's response latency — every verified pair in the file

| Request | Sent | Reply | Days |
|---|---|---|---|
| Calderbank #2 | 1 Jul 2026 | rejection | **15** |
| disclosure-list request | 24 Jul 2026 | holding reply, *"this week"* | **10** |
| — same request | 24 Jul 2026 | amended List of Documents actually delivered | **21** |
| WP material-development letter | 31 Jul 2026 | *"position unchanged"* | **14** |
| Form 24 + Form 25 (303 facts) | 28 Aug 2026 | full response, 298 admitted | **11** |
| request for documents not admitted | 9 Sep 2026 | extension sought | **1** |

**Substantive median 11 days, range 10–15. Acknowledgement latency 1 day.**
⭐ The only deadline with a statutory consequence — r 49's 14 days — she met **3 days early**.
⭐ The only soft commitment she gave (*"as soon as possible this week"*) slipped **11 further days**.

### A2 · The 2024 behavioural pattern in the admitted record

| Who raised it | What | Time to answer |
|---|---|---|
| MASPER Registrar (clinician) | emergency calls to wrong teams, 3 May | **5 d 18 h** |
| Integrated Respiratory Service | wrong directory entry, 15 May | **no reply on the record** |
| IRS again | same, 20 May | **no reply on the record** |
| **The Appellant**, escalating the IRS issue | 20 May 2:05 pm | **2 h 25 m** |
| **The Appellant**, asking about the manager's office hours | 15 May 1:15 pm | **5 h 08 m**, at 6:23 pm |
| **The Appellant**, fatigue enquiry (costs money) | 8 Apr | **23 days** |

⭐ **Speed is inversely related to cost.** What is free to answer is answered within hours. What
concedes something, or costs money, waits weeks — or is not answered at all.

### A3 · Weight of the record
May 2024 carries **58** admitted events; no other month exceeds 11. Actor frequency across the
admitted record: **Taylor 48, Reese 29**, Kwok 8, Marriott 7, Stibbard 5.

---

## B · THE PREDICTIONS

### B1 · Matheson answers the production request on 24–25 September, not before
**Confidence 75%** (late 15%, early 10%).
She asked for 25 September — **15 days** from her request, the top of her own 10–15 day band, and
...
She said she may *"reach out to MSH"*. MSH is a non-party; the last time she had to go to MSH the
...
298 facts are admitted, so nothing documentary is left to prove. What remains is characterisation
...
Calderbank #2 was rejected 16 July and the without-prejudice position was *"unchanged"* on
14 August — ⭐ **both before the 8 September admissions.** The documentary position changed
...
genuine settlement reassessment (B7 → closer to 50/50).

**Nothing in the repo tells me whether that is happening.** It is the single biggest thing I cannot
...
These are calibrated judgements, not computed probabilities. The latency table and the actor counts
are data; the confidences are mine. The 2024 behavioural pattern at A2 is the strongest thing here
